...
@section('content')
    <div id="header" style="background-image: url('/images/background/header.svg')">
        ...
        <div class="dropdown header-buttonflex header-register" style="background-color: #043A5B;">
            <a id="my-dropdown" href="section=mysection" class="dropdown-toggle" style="color: white; text-align: center;" data-toggle="dropdown">{{ Auth::user()->pseudonyme }}</a>
    ...
    <div id="part" class="blog">
        ...
        <img src="/images/stain-1.svg" alt="">
